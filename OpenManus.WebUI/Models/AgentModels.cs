...
public class AgentMemory
{
    ...
    public void AddMessage(int orderby, string role, string content, string? toolCallId = null)
    {
    ...
    /// <param name="toolCallId">工具调用ID</param>
    public void AddMessage(int orderby, string role, string content, AgentExecutionResult? executionStatus, string? toolCallId = null)
    {
        Messages.Add(new AgentMessage
        {
            OrderBy = orderby,
